...
java -XXaltjvm=dcevm -javaagent:C:/dev/hotswap-agent.jar=autoHotswap=true -Djava.awt.headless=true -DLOG_DIR=c:/temp -cp "%CLASSPATH%" dhan.frontend.server.AppStart dev